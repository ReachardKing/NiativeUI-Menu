print("Version_checker: This will check for you if there is any new releases ^8Enjoy^7")

Citizen.CreateThread( function()
    updatePath = "https://github.com/ReachardKing/NiativeUI-Menu/blob/main/Menu/Version-Checker.json" -- your git user/repo path
    resourceName = "CanadianMenu("..GetCurrentResourceName()..")" -- the resource name
