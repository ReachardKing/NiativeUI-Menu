...
function SecondItem(menu)
    ...
    local Blazer5 = NativeUI.CreateItem("Blazer5", "spawns Blazer5")
    submenu.OnItemSelect = function(sender, item, index)
        if item == Blazer5 then
            spawnCar('Blazer5')
            notify('Vehicle spawned')
        end
    end
    local Rhino = NativeUI.CreateItem("Rhino", "spawns Rhino")
    ...
    submenu:AddItem(Blazer5)
    submenu:AddItem(Rhino)
...
function EighthtItem(menu)
    ...
    local DeleteOccupentVehicles = NativeUI.CreateCheckboxItem("Delete Occupent Vehicles", bool,  "Stright Forword")
    submenu.OnCheckboxChange = function(sender, item, checked_)
    ...
    local DeleteEmptyVehicles = NativeUI.CreateCheckboxItem("Delete Empty Vehicles", bool,  "Stright Forword")
    submenu.OnCheckboxChange = function(sender, item, checked_)
    ...
    local DeletePoliceVehicles = NativeUI.CreateCheckboxItem("Delete Police Vehicles",  bool, "Stright Forword")
    submenu.OnCheckboxChange = function(sender, item, checked_)
    ...
    local DeletePersistentVehicles = NativeUI.CreateCheckboxItem("Delete Persistent Vehicles",  bool,  "Stright Forword")
    submenu.OnCheckboxChange = function(sender, item, checked_)
    ...
    local DeleteExemptVehicles = NativeUI.CreateCheckboxItem("Delete Exempt Vehicles",  bool, "Stright Forword")
    submenu.OnCheckboxChange = function(sender, item, checked_)
    ...
    local DeletePersistenteped = NativeUI.CreateCheckboxItem("Delete Persistente Ped",  bool, "Stright Forword")
    submenu.OnCheckboxChange = function(sender, item, checked_)
    ...
    local DeleteLivingpeds = NativeUI.CreateCheckboxItem("Delete Living Peds", bool,  "Stright Forword")
    submenu.OnCheckboxChange = function(sender, item, checked_)
    ...
    local confirm = NativeUI.CreateItem("confirm", "Confirns selection")
    submenu.OnItemSelect = function(sender, item)
